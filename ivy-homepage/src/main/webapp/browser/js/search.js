! function() {
	...
	function showTypeList(){
	    if(document.getElementById('search-type-list').style.display === 'none'){
            document.getElementById('search-type-list').style.display = 'block';
        }else if (document.getElementById('search-type-list').style.display === 'block'){
            document.getElementById('search-type-list').style.display = 'none'
        }
    }