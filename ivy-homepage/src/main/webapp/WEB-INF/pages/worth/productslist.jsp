...
<link rel="stylesheet" type="text/css" href="/worth/css/children.css">
...
<div class="contentbox">
	<!-- banner -->
	<div class="zy_banner">
		<img src="images/web/zy_banner02.jpg">
		<div class="zy_title">
			<div>
				<h1>医疗器械</h1>
		...
		<div class="wid_main">
			<div class="zy_navbox">
				<div class="weizhi">
					<div>
						<p>
							<img src="images/web/PIN2.png">当前位置：<a href="index.html">首页</a> > <a href="about.html">医疗器械</a> > <span>微型医疗器械</span>
						</p>
						<p>
			...
			<div class="zy_conbox zy_chanp">
				<ul>
					<li>
						<a href="products.html">
							<div class="pic"><img src="images/pic01.jpg" /></div>
							<div class="title">
								<h2>磁共振成像诊断</h2>
								<i></i>
					...
					<li>
						<a href="products.html">
							<div class="pic"><img src="images/pic02.jpg" /></div>
							<div class="title">
								<h2>磁共振成像诊断</h2>
								<i></i>
								<p>磁共振成像诊断是21世纪最伟大的医疗器械创造之一，它的出现让很多难以诊断的疾病无处遁形...</p>
					...
					<li>
						<a href="products.html">
							<div class="pic"><img src="images/pic03.jpg" /></div>
							<div class="title">
								<h2>磁共振成像诊断</h2>
								<i></i>
								<p>磁共振成像诊断是21世纪最伟大的医疗器械创造之一，它的出现让很多难以诊断的疾病无处遁形...</p>
